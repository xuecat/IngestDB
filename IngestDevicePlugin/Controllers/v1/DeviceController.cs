...
namespace IngestDevicePlugin.Controllers.v1
{
    ...
    public class DeviceController : ControllerBase
    {
        ...
        //public string Get() { return "DBPlatform Service is already startup at " + DateTime.Now.ToString(); }
        ...
        [ApiExplorerSettings(GroupName = "v1")]
        public async Task<string> GetSetSignalDeviceMap([FromQuery, DefaultValue(1010)]int nSignalID,
                                                        [FromQuery, DefaultValue(77)]int nDeviceID,
                                                        [FromQuery, DefaultValue(777)]int nDeviceOutPortIdx,
                                                        [FromQuery, DefaultValue(3)]emSignalSource SignalSource)
        {
        ...
        [ApiExplorerSettings(GroupName = "v1")]
        public async Task<bool> GetModifyDevState([FromQuery, DefaultValue(20)]int nID,
                                                  [FromQuery, DefaultValue(1)]int nDevState,
                                                  [FromQuery, DefaultValue(0)]int nMSVMode)
        {
        ...
        [ApiExplorerSettings(GroupName = "v1")]
        public async Task<GetBestChannelIDBySignalID_out> GetBestChannelIDBySignalID([FromQuery, DefaultValue(20)]int nSignalID,
        ...
        /// <summary>
        /// 更改ModifySourceVTRIDAndUserCode
        /// </summary>
        [HttpGet("ModifySourceVTRIDAndUserCode"), MapToApiVersion("1.0")]

        [ApiExplorerSettings(GroupName = "v1")]
        public async Task<ModifySourceVTRIDAndUserCode_out> ModifySourceVTRIDAndUserCode([FromQuery, DefaultValue(666)]int nID,
                                                                                         [FromQuery, DefaultValue(777)]int nSourceVTRID,
                                                                                         [FromQuery, DefaultValue(9527)]string userCode)
        {
        ...
        public async Task<ModifySourceVTRIDAndUserCode_out> ModifySourceVTRIDAndUserCodeByChannelIDArray([FromBody]ModifySourceVTR_in pIn)
        {
            ...
            try
            {
                if(pIn.nIDArray != null)
                {
                    ...
                    {
                        await _deviceManage.ModifySourceVTRIDAndUserCodeAsync(pIn.nSourceVTRID,
                                                                              pIn.userCode,
                                                                              pIn.nIDArray);
                    }
                }
